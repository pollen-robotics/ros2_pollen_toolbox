...
class PollenPlacoKinematics(LifecycleNode):
    def __init__(self):
        super().__init__("pollen_placo_kinematics_node")
        ...
        # Using the collision.json file from reachy_placo. TODO this shoult be a named parameter so we can handle different robots 
        collision_file_location = os.path.join(os.path.dirname(ik_reachy_placo.__file__), "reachy")

        self.ik_reachy_placo = ik_reachy_placo.IKReachyQP(viewer_on=True, collision_avoidance=False)
        ...
        for prefix in ("l", "r"):
            ...
            if chain.getNrOfJoints():
                ...
                self.fk_srv[arm] = self.create_service(
                    ...
                    srv_name=f"/{arm}/forward_kinematics_placo",
                ...
                self.ik_srv[arm] = self.create_service(
                    ...
                    srv_name=f"/{arm}/inverse_kinematics_placo",
                ...
                self.reach_srv[arm] = self.create_service(
                    ...
                    srv_name=f"/{arm}/reachability_placo",
                ...
                forward_position_pub = self.create_publisher(
                    ...
                    topic=f"/{arm}_forward_position_controller/commands_placo",
                    qos_profile=5,
                )
        ...
        if chain.getNrOfJoints():
            ...
            srv = self.create_service(
                srv_type=GetForwardKinematics,
                srv_name="/head/forward_kinematics_placo",
            ...
            srv = self.create_service(
                srv_type=GetInverseKinematics,
                srv_name="/head/inverse_kinematics_placo",
            ...
            head_forward_position_pub = self.create_publisher(
                msg_type=Float64MultiArray,
                topic="/neck_forward_position_controller/commands_placo",  # need
                qos_profile=5,
            )
